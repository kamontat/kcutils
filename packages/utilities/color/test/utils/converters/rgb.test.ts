...
describe("RGB to RGB", () => {
  ...
  test.each([
    ...
    [
      undefined as unknown as RGB,
      { a: 1, r: 0, b: 0, g: 0, type: type.number },
    ],
    [
      { a: 0.5, r: 123, g: 11, b: 21 } as RGB,
      { a: 0.5, r: 123, g: 11, b: 21, type: type.number },
    ],
    [
      { a: 0.5, r: 123 } as RGB,
      { a: 0.5, r: 123, g: 0, b: 0, type: type.number },
    ],
    [
      { r: 11, type: type.decimal } as RGB,
      { a: 1, r: 11, g: 0, b: 0, type: type.decimal },
    ],
  ...
  test("convert unknown type object will return default value", () => {
    expect(rgbToRgb(undefined as any, type.decimal)).toEqual(
      enforceRGB({ type: type.decimal })
    );
  });

  test("convert empty type object will return default value", () => {
    expect(rgbToRgb({} as RGB, type.percent)).toEqual(
      enforceRGB({ type: type.percent })
    );
  });
  ...
  test.each(
    emptyArray<NumberTypeString, RGB>(
      [
        { type: type.number } as RGB,
        type.decimal,
        { type: type.decimal, a: 1, r: 0, g: 0, b: 0 } as RGB,
      ],
      [
        { type: type.percent } as RGB,
        type.percent,
        { type: type.percent, a: 1, r: 0, g: 0, b: 0 } as RGB,
      ],
      [
  ...
  test.each(
    emptyArray<RGBHexOptions | undefined, HEX>(
      ...
      [
        { type: "percent" } as RGB,
        { minify: true },
        { type: type.hex3, a: 1, x: "000" },
      ],
      [
        { type: "number" } as RGB,
        { alpha: true },
        { type: type.hex8, a: 1, x: "000000ff" },
      ],
      [
        { type: "decimal" } as RGB,
        { alpha: true, minify: true },
        { type: type.hex4, a: 1, x: "000f" },
      ],
...
describe("RGB to HSL color", () => {
  ...
  test.each([
    ...
    [
      { r: 123, g: 234, b: 12, type: "number" } as RGB,
      definedHSL({ h: 0.25, s: 0.9, l: 0.49 }),
    ], // no alpha
    [
      { r: 36, g: 0, b: 194, type: "number" } as RGB,
      definedHSL({ h: 0.7, s: 1, l: 0.38 }),
    ],
    [
      { r: 222, g: 51, b: 1, a: 0.5554445, type: "number" } as RGB,
      definedHSL({ h: 0.04, s: 1, l: 0.44, a: 0.555445 }),
    ],
    [
      { r: 222, g: 99, b: 111, a: 0.003, type: "number" } as RGB,
      definedHSL({ h: 0.98, s: 0.65, l: 0.63, a: 0.003 }),
    ],
...
describe("RGB to HSV color", () => {
  ...
  test.each([
    ...
    [
      { r: 123, g: 234, b: 12, type: "number" } as RGB,
      definedHSV({ h: 0.25, s: 0.95, v: 0.92 }),
    ], // no alpha
    [
      { r: 36, g: 0, b: 194, type: "number" } as RGB,
      definedHSV({ h: 0.7, s: 1, v: 0.76 }),
    ],
    [
      { r: 222, g: 51, b: 1, a: 0.5555556, type: "number" } as RGB,
      definedHSV({ h: 0.04, s: 1, v: 0.87, a: 0.555556 }),
    ],
    [
      { r: 222, g: 99, b: 111, a: 0.003, type: "number" } as RGB,
      definedHSV({ h: 0.98, s: 0.55, v: 0.87, a: 0.003 }),
    ],
...
describe("RGB to Named color", () => {
  test.each([
    ...
    [
      { r: 0, g: 255, b: 0, a: 2, type: "number" } as RGB,
      { a: 1, n: "lime" } as Named,
    ],
