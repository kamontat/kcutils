...
export type MaskOption = { enabled: boolean; front: number; back: number; mask: string };
export const defaultMaskOption: MaskOption = { enabled: true, front: 15, back: 15, mask: "*" };
export const mask = (str: Optional<string>, opt: Partial<MaskOption>): string => {
